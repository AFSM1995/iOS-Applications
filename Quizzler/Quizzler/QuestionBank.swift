...
//  Quizzler
//
//  Created by Álvaro Santillan on 11/18/18.
//  Copyright © 2018 London App Brewery. All rights reserved.
//

import Foundation

// When a new QuestionBank object is initualized, it will go through init method and
// create 13 questions in the array so we can accsess them
class QuestionBank {
    
    // Array of Objects of type Question from Question.swift file
    var list = [Question]()
